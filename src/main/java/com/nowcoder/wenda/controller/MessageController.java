...
public class MessageController {
    ...
    public String getConversationList(Model moddel) {
        if (hostHolder == null) {
        ...
        for (Message message : conversationList) {
            ...
            vo.set("unread", messageService.getConversattionUnreadCount(localUserId,message.getConversationId()));
            conversations.add(vo);
        }
        moddel.addAttribute("conversations", conversations);
        return "letter";
    }
